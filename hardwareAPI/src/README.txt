...
To build the example in Linux, Unix OS, execute:
gcc -o test-hwAPI test-hwAPI.c hardwareAPI.o -lpthread -lsocket

To build the example with Visual Studio in Windows:
Open project file hardwareAPI.dsp. If a new project is created from scratch, then 
one should specify header file location and linking library as showing in *.bmp files.
